...
//     $(".canhcam-shop-details-1 #zoomimg").elevateZoom({
//         responsive: true,
//         gallery: "product-control",
//         galleryActiveClass: "active"
//     });
//     $(".canhcam-shop-details-1 .product-control .item").each(function() {
//         $(this).click(function(e) {
//             var currentValue = $(this).find('img').attr('data-preview-image')
//             var currentValueZoom = $(this).find('img').attr('data-zoom-image')
//             $('.canhcam-shop-details-1 .product-control .item').removeClass('active')
