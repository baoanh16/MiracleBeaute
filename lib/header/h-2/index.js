$(document).ready(function () {
	...
	if(window.location.pathname.search('san-pham')>=1 || window.location.pathname.search('product')>=1){
		$('.main-nav .nav-item.dropdown-list:nth-child(4)').addClass('active')
	}
	if(window.location.pathname.search('lieu-trinh')>=1 || window.location.pathname.search('treatment')>=1){
		$('.main-nav .nav-item.dropdown-list:nth-child(5)').addClass('active')
	}
	if(window.location.pathname.search('giai-phap')>=1 || window.location.pathname.search('solution')>=1){
		$('.main-nav .nav-item.dropdown-list:nth-child(6)').addClass('active')
	}
	if(window.location.pathname.search('tin-tuc')>=1 || window.location.pathname.search('news')>=1){
		$('.main-nav .nav-item.dropdown-list:nth-child(7)').addClass('active')
	}
});
$(window).on('scroll', () => {
