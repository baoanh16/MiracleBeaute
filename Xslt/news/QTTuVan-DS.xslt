 ...
 exclude-result-prefixes="msxsl">
	...
	<xsl:template match="News">
		...
		<xsl:if test="position() = 1">
			<!-- <xsl:apply-templates select="/NewsList/News" mode="NewsFirst"></xsl:apply-templates> -->
		...
		<xsl:if test="position() = 2">
			<!-- <xsl:apply-templates select="/NewsList/News" mode="NewsSecond"></xsl:apply-templates> -->
			<div class="row">
		...
		<xsl:if test="position() = 3">
			<!-- <xsl:apply-templates select="/NewsList/News" mode="NewsThird"></xsl:apply-templates> -->
			<div class="row">
